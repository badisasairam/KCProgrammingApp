...
class SchoolsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = Schools.shared[indexPath.row].name
        return cell
    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let team = segue.destination as! TeamsTableViewController
        team.school=Schools.shared[tableView.indexPathForSelectedRow!.row]
    }
}
